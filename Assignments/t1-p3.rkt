...
(define (parse-args arg)
  (match arg
    [(list x ': type @ contract) (arg-cont x (parse-type type) contract)]
    [(list x '@ contract) (arg-cont x (parse-type 'Any) contract)]
    [(list x ': type) (arg-type x (parse-type type))]
    [(? symbol?) (arg-any arg)]))

...
(def stream-zipWith '{define stream-zipWith
                       {fun {f s1 s2}
                            {stream {f {stream-hd s1}
                                       {stream-hd s2}}
                                    {stream-zipWith f {stream-tl s1}
                                                    {stream-tl s2}}}}})
...
; auxiliary function for the fibonacci stream
(def stream-aux '{define stream-aux
                   {fun {f0 f1} {stream f1 {stream-aux f1 {+ f0 f1}}}}})
